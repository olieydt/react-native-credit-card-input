...
import { removeNonNumber, removeLeadingSpaces, removeNonAlphaNum, removeNonAlphaSpace } from "./Utilities";
...
export default class CCFieldFormatter {
  ...
  formatValues = (values) => {
    ...
    return pick({
      ...
      name: removeLeadingSpaces(removeNonAlphaSpace(values.name)),
